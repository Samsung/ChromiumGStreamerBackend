...
IPC_MESSAGE_CONTROL2(MediaPlayerMsg_Load,
        int /* player_id */,
		GURL /* url */)

IPC_MESSAGE_CONTROL1(MediaPlayerMsg_Start,
        int /* player_id */)

IPC_MESSAGE_CONTROL1(MediaPlayerMsg_Pause,
		int /* player_id */)
...
IPC_MESSAGE_ROUTED1(MediaPlayerMsg_MediaBufferingUpdate,
        int /* percent */)

// A media playback error has occurred.
IPC_MESSAGE_ROUTED1(MediaPlayerMsg_MediaError,
        int /* error */)
