...
IPC_MESSAGE_CONTROL1(MediaMsg_EstablishChannel,
                     int /* client_id */)
...
IPC_MESSAGE_CONTROL1(MediaHostMsg_Initialized,
                     bool /* result */)
...
IPC_MESSAGE_CONTROL1(MediaHostMsg_DestroyChannel,
                     int32 /* client_id */)

// Message from the media process to add a media process log message to the about:media page.
