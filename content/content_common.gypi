...

{
  ...
  'variables': {
    ...
    'private_common_sources': [
      ...
      'common/media/media_player_channel.cc',
      'common/media/media_player_channel.h',
      'common/media/media_player_channel_filter.cc',
      'common/media/media_player_channel_filter.h',
      'common/media/media_player_channel_host.cc',
      'common/media/media_player_channel_host.h',
